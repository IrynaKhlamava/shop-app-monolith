...
public class AppMessages {
    ...
    public static final String NOT_FOUND_BY_ID = "%s with ID '%s' not found";
    ...
    public static final String DUPLICATE_KEY_TITLE = "Duplicate Key";
    public static final String RESOURCE_ALREADY_EXISTS = "Resource already exists";
    public static final String DATABASE_ERROR_TITLE = "Database Error";
    public static final String DATABASE_ERROR_MESSAGE = "A database error occurred. Please try again";
    ...
    public static final String ORDER_NUMBER_GENERATION_FAILED = "Failed to generate order number";
